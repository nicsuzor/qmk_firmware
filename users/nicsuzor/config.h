...
#   define RGB_MATRIX_LED_PROCESS_LIMIT (DRIVER_LED_TOTAL + 4) / 2 //5 // limits the number of LEDs to process in an animation per task run (increases keyboard responsiveness)
