...
[_LOWER] = LAYOUT_ortho_5x12(
    RESET,  KC_NO,  KC_NO,   LCTL(KC_PGUP), LCTL(KC_PGDN), KC_NO, KC_CIRC, KC_AMPR, KC_ASTR, KC_AT, KC_HASH, KC_BSPC,
    ...
    KC_LCTL, KC_LGUI,BACKLIT,KC_LALT,_______, KC_SPC,KC_SPC,RAISE,_______, KC_VOLD, KC_VOLU, TO(0)
),
...
[_RAISE] = LAYOUT_ortho_5x12(
  ...
  KC_LCTL, KC_LGUI, BL_STEP, KC_LALT, LOWER,   KC_SPC,  KC_SPC,  _______,   KC_MNXT, KC_VOLD, KC_VOLU, TO(0)
),
